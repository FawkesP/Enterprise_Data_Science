...
def import_cases_data():
    ''' Get data by a git pull request, the source code has to be pulled first
        ...
        not present then clone the data from GitHub. Checking whether the data is present,
        if not downloading it and saving it in a variable.
    '''
    ...
    # Downloading CSV file used for cases per population plot:
    ...
    # Getting all the names of countries in a list for further use:
...
def import_vacc_data():
    ''' Get data from the url given for the csv and store it in a variable. If there is no Repository 
    ...
    #Reading the vaccination csv data from url into a variable:
