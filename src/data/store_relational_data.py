...
# Importing required python files from source code:
# Stating source path:
path = ('../src/data/')
sys.path.append(path)

# Importing the import_data file:
import import_data

# Defining a function to store data in the data folder:
def store_relational_data():
    ''' Data we got from import_data file is raw and needs to be filtered and sorted for plotting.
    In this function, we filter, we transpose, remove unwanted data and save final dataframes in data/processed folder for plotting.
    ...
    # Saving the confirmed cases .csv file for plot:
    ...
    # Getting the earliest starting date for sorting dataset:
    ...
    # Adding columns of the cases in country and dividing it by population for cases per population plot:
    for each in list_cases_country:
        df_country_info['iso_code'].unique()
    ...
    # Storing the final created dataframe as a csv file for use while plotting:
    ...
    # Sorting the earliest dates of all the data collection for vaccination:
    ...
    # Adding vaccination data to the dataframe for vaccination per population plot:
    for each in list_cases_country:
        df_vaccination_info['iso_code'].unique()
    ...
    # Saving the vaccination dataframe to processed folder for plot:
